...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2024 at 01:39 PM
...
CREATE TABLE `users` (
  ...
  `user_type` enum('patient','healthcare_provider','pharmacy_staff') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `strengths`
  MODIFY `strength_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `strengths`
  ADD CONSTRAINT `strengths_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
COMMIT;
